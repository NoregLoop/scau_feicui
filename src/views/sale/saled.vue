<template>
    <div class="front">
        <el-collapse v-model="activeNames" class="front-collapse"
            ...
            <el-collapse-item class="collapse-1" :title="collapseName" name="1">
                <el-form class="left" :model="saledForm" label-width="120px">
                    <el-form-item class="left-input" label="仓库">
                        <el-select v-model="saledForm.region" placeholder="请选择">
                            <el-option label="启用" value="shanghai" />
                            <el-option label="停用" value="beijing" />
                        </el-select>
                    </el-form-item>
                    <el-form-item class="left-input" label="出库人员">
                        <el-input v-model="saledForm.region" />
                    </el-form-item>
                    <el-form-item class="left-input" label="仓库">
                        <el-input v-model="saledForm.region" />
                    </el-form-item>
    ...
    <div class="center">
        <el-button type="primary">取消已售</el-button>
        <el-button type="primary">已售退货</el-button>
