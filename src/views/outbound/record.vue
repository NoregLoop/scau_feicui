<template>
  <div class="front">
    <el-collapse v-model="activeNames"
      ...
      <el-collapse-item :title="collapseName" class="collapse">
        <el-form class="left" :model="outboundorder" label-width="120px">
          <el-form-item class="left-input" label="货品条码">
            <el-input v-model="outboundorder.region" />
          </el-form-item>
          <el-form-item class="left-input" label="出库单号">
            <el-input v-model="outboundorder.region" />
          </el-form-item>
          <el-form-item class="left-input" label="出借客户">
            <el-select v-model="outboundorder.region" placeholder="请选择">
  ...
  <div class="tail">
    <div class="tail-action">
      ...
      <el-popover :visible="visible" placement="top" :width="160">
        ...
        <template #reference>
          <el-button type="primary" @click="visible = true">显示设置</el-button>
        </template>
      </el-popover>
    </div>
