<template>
  <div class="data">
    <el-table :data="tableData()" style="width: 100%">
      ...
      <el-table-column prop="name" label="价格信息" width="180" />
      <el-table-column prop="inboundno" label="入库单单号" width="180" />
      <el-table-column prop="name" label="数量"  />
      <el-table-column prop="name" label="市场还货" />
      <el-table-column prop="name" label="供应商" />
      <el-table-column prop="name" label="入库类型" />
      <el-table-column prop="name" label="入库人员" />
